                ...
                <div className="overflow-x-auto">
                  ...
                  `}
                                >
                                    ...
                                    {/* note */}
                                    <td className="px-6 py-4 text-text font-bold text-xs tracking-wide">
                                        {stagiair.Note}
                                    </td>
                                    {/* status */}
                                    <td className={`px-6 py-4  font-medium ${stagiaireStatus(stagiair.Note) === 'Valide' ? 'text-green-600' : 'text-red-700'}`}>
                                        {stagiaireStatus(stagiair.Note)}
                                    </td>
                                </tr>
                            ))}
                        </tbody>
